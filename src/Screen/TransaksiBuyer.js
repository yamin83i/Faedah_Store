...
class Penjualan extends Component {
  ...
  getdata = () => {
    const url = 'https://faedah.herokuapp.com/api/finishb';
      ...
      <View style={{flex: 1}}>
        <View style={styles.header}>
          <Icon
            ...
            size={30}
            color="white"
            onPress={() => this.props.navigation.replace("Home",{screen:"Akun"})}
          />
                ...
                return (
                  <TouchableOpacity
                    ...
                    <View style={{maxWidth:150}}> 
                      ...
                      <Text style={styles.tek}>Membeli {value.qty} stok</Text>
